...
export default function Input () {
  return (
    <ClLayout>
      ...
      <ClTitleBar title='标题宽度' textColor='black' type='icon' subTitle='title'/>
      <ClCard>
        <ClInput title='auto' placeholder='请输入姓名' />
        <ClInput title='200宽度' placeholder='请输入年龄' type='number'  titleWidth={200} />
      </ClCard>

      <ClTitleBar title='占位符' textColor='black' type='icon' subTitle='placeholder'/>
      <ClCard>
      ...
      <ClTitleBar title='禁止输入' textColor='black' type='icon' subTitle='disabled'/>
      <ClCard>
        <ClInput placeholder='我禁止输入' type='text' disabled />
      </ClCard>

      <ClTitleBar title='自动上推' textColor='black' type='icon' subTitle='adjustPosition'/>
      <ClCard>
        <ClInput placeholder='我自动上推' type='text' adjustPosition />
      </ClCard>

      <ClTitleBar title='后置内容' textColor='black' type='icon' subTitle='more'/>
      <ClCard>
