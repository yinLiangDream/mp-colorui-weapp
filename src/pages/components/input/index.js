...
export default function Input () {
  return (
    <ClLayout>
      ...
      <ClTitleBar title='标题' textColor='black' type='icon' subTitle='title' subTitleColor='shadow' />
      <ClCard>
      ...
      <ClTitleBar title='长度' textColor='black' type='icon' subTitle='long' subTitleColor='shadow' />
      <ClCard>
        <ClInput placeholder='我只能输入 10 个字符' type='text' maxLength={10} />
      </ClCard>

      <ClTitleBar title='禁止输入' textColor='black' type='icon' subTitle='disabled' subTitleColor='shadow' />
      <ClCard>
        <ClInput placeholder='我禁止输入' type='text' disabled />
      </ClCard>

      <ClTitleBar title='自动上推' textColor='black' type='icon' subTitle='adjustPosition' subTitleColor='shadow' />
      <ClCard>
        <ClInput placeholder='我自动上推' type='text' adjustPosition />
      </ClCard>

      <ClTitleBar title='后置内容' textColor='black' type='icon' subTitle='more' subTitleColor='shadow' />
      <ClCard>
