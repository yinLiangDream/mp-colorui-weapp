...
export default class ShopBar extends Taro.Component {
  ...
  render () {
    return (
      <ClLayout>
        <ClTitleBar title='背景色' textColor='black' subTitleColor='shadow' type='icon' subTitle='bgColor' />
        <ClCard>
        ...
        <ClTitleBar title='分割线' textColor='black' subTitleColor='shadow' type='icon' subTitle='border' />
        <ClCard>
          <ClShopBar onClickTab={(index) => {this.clickIcon(index)}}
        ...
        <ClTitleBar title='角标' textColor='black' subTitleColor='shadow' type='icon' subTitle='badge' />
        <ClCard>
          <ClShopBar onClickTab={(index) => {this.clickIcon(index)}}
