...
export default function ImagePicker () {
  return (
    <ClLayout>
      ...
      <ClTitleBar title='最多选择 3 张图片' textColor='blue' type='sub-title' subTitle='most' subTitleColor='shadow' />
      <ClCard>
        <ClImagePicker chooseImgObj={{ count: 3 }} />
      </ClCard>

      <ClTitleBar title='删除图片确认操作' textColor='blue' type='sub-title' subTitle='beforeDelete' subTitleColor='shadow' />
      <ClCard>
