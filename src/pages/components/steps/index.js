  ...
  render () {
    ...
    return (
      <ClLayout>
        ...
        <ClTitleBar title='自定义图标' textColor='blue' type='icon' subTitle='custom' subTitleColor='shadow' />
        <ClCard>
        ...
        <ClTitleBar title='文字位置' textColor='blue' type='icon' subTitle='stepTitlePosition' subTitleColor='shadow' />
        <ClCard>
