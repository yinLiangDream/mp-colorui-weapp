...
export default class Accordion extends Taro.Component {
  ...
  render () {
    return (
      <ClLayout>
        <ClTitleBar type='icon' title='普通模式' iconColor='red' textColor='black' />
        {this.renderContent(false, true)}
        <ClTitleBar type='icon' title='卡片模式' iconColor='red' textColor='black' />
        {this.renderContent(true, true)}
        <ClTitleBar type='icon' title='禁止动画' iconColor='red' textColor='black' />
        {this.renderContent(false, false)}
        <ClTitleBar type='icon' title='展开速度' iconColor='red' textColor='black' />
