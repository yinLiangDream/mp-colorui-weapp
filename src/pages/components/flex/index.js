...
export default function Flex () {
  ...
  return (
    <ClLayout>
      <ClTitleBar title='固定尺寸' textColor='blue' type='sub-title' subTitle='basis' subTitleColor='shadow' />
      {base}

      <ClTitleBar title='比例布局' textColor='blue' type='sub-title' subTitle='flex' subTitleColor='shadow' />
      <ClCard>
        <ClFlex>
          {per}
        </ClFlex>
      ...
      <ClTitleBar title='水平对齐' textColor='blue' type='sub-title' subTitle='justify' subTitleColor='shadow' />
      {justifyComponent}

      <ClTitleBar title='垂直对齐' textColor='blue' type='sub-title' subTitle='align' subTitleColor='shadow' />
      {alignComponent}
    </ClLayout>
  )
}
