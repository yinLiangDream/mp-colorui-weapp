...
export default class TextView extends Taro.Component {
  render () {
    ...
    return (
      <ClLayout>
        <ClTitleBar title='文字大小' textColor='blue' type='icon' subTitle='size' subTitleColor='shadow' />
        <ClLayout padding='normal' paddingDirection='around'>
          {sizeComponent}
        </ClLayout>

        <ClTitleBar title='文字颜色' textColor='blue' type='icon' subTitle='color' subTitleColor='shadow' />
        <ClFlex justify='around' align='center' wrap>
          {colorComponent}
        </ClFlex>

        <ClTitleBar title='文字截断' textColor='blue' type='icon' subTitle='cut' subTitleColor='shadow' />
        <ClFlex>
          <ClCard bgColor='grey'>
        ...
        <ClTitleBar title='文字对齐' textColor='blue' type='icon' subTitle='align' subTitleColor='shadow' />
        <ClFlex wrap>
          <View style={{ flex: 1 }}>
            <ClCard>
              <ClText cut align='left'>泰国、新加坡、印度尼西亚~ </ClText>
        ...
        <ClTitleBar title='特殊' textColor='blue' type='icon' subTitle='special' subTitleColor='shadow' />
        <ClFlex wrap>
          <View style={{ flex: 1 }}>
            <ClCard>
